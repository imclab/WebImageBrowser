package edu.ucsd.ncmir.spl.XMLUtil;
...

{
    ...
    /**
     * A convenience method to extract an integer attribute from an XML
     * <code>Element</code>.
     * @param element The <code>Element</code>.
     * @param name The name of the attribute to be extracted.
     * @return The parsed value of the <code>Element</code>'s
    ...
    /**
     * A convenience method to extract an boolean attribute from an XML
     * <code>Element</code>.
     * @param element The <code>Element</code>.
     * @param name The name of the attribute to be extracted.
     * @return The parsed value of the <code>Element</code>'s
