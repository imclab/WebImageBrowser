...
public class XTKCylinder
    extends JavaScriptObject

{

    protected XTKCylinder() {}  // No instantiations allowed.

    public native static XTKCylinder create()
    /*-{

        return new $wnd.X.cylinder();
    ...
    public native final JsArray getEnd()
    /*-{
    ...
    public native final void setEnd( JsArray end )
    /*-{
    ...
    public native final JsArray getStart()
    /*-{
    ...
    public native final void setStart( JsArray start )
    /*-{
