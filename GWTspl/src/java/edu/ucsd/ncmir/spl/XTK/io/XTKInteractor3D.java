...
public class XTKInteractor3D
    extends JavaScriptObject

{

    protected XTKInteractor3D() {};  // No instantiations allowed.

    public native static XTKInteractor3D create()
    /*-{

        return new $wnd.X.interactor3D();
