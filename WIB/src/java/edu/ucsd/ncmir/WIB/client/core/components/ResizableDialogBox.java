 ...
 *
 * Based on TractionDialogBox by Traction Software, Inc. Renamed to ResizableDialogBox and
...
/**
 * Extension of the standard GWT DialogBox to provide a more "window"-like functionality. By default, the ResizableDialogBox
 ...
 * <br><br>
 * The ResizableDialogBox relies on the css settings of {@link DialogBox} for styling of the border and header. It also uses
 * the following classes to style the additional elements:
 *
 * <pre>
 *  .gwt-extras-ResizableDialogBox
 *      the box itself
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-container
 *      the div holding the contents of the box
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls
 ...
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls a.gwt-extras-dialog-close
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls a.gwt-extras-dialog-close:hover
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls a.gwt-extras-dialog-minimize
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls a.gwt-extras-dialog-minimize:hover
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls a.gwt-extras-dialog-maximize
 *  .gwt-extras-ResizableDialogBox .gwt-extras-dialog-controls a.gwt-extras-dialog-maximize:hover
...
public class ResizableDialogBox
    extends DialogBox
    implements HasOpenHandlers<ResizableDialogBox>
	       
{
    ...
    /**
     * Creates a ResizableDialogBox which is permanent (no auto-hide), non-modal, has a "minimize"- and "close"-button
     ...
     * <br><br>
     * This is the equivalent for calling <code>ResizableDialogBox(false, false, true, false)</code>.
     *
     * @see ResizableDialogBox#ResizableDialogBox(boolean, boolean, boolean, boolean)
     */
    ...
    /**
     * Creates a ResizableDialogBox which is permanent, non-modal, has a "minimize"- and "close"-button and is optionally resizeable.
     ...
     */
    public ResizableDialogBox(boolean resizeable) {
	this(false, false, true, true, resizeable);
    }
    
    /**
     * Creates a ResizableDialogBox which is permanent and nonmodal, optionally resizeable and/or has a "minimize"- and
     ...
     */
    public ResizableDialogBox(boolean showCloseIcon, boolean resizeable) {
     ...
     * @param showCloseIcon <code>true</code> to show "close"-icon in the top right corner of the header
     */
    public ResizableDialogBox(boolean showMinimizeIcon, boolean showCloseIcon, boolean resizeable) {
        this(false, false, showMinimizeIcon, showCloseIcon, resizeable);
    }
    
    /**
     * Creates a ResizableDialogBox which is permanent, optionally modal, resizeable and/or has a "minimize"- and
     * "close"-button. The dialog box should not be shown until a child widget has been added using
     * {@link #setWidget(Widget)}.
     *
     ...
     * @param showCloseIcon <code>true</code> to show "close"-icon in the top right corner of the header
     */
    public ResizableDialogBox(boolean modal, boolean showMinimizeIcon, boolean showCloseIcon, boolean resizeable) {
        this(false, modal, showMinimizeIcon, showCloseIcon, resizeable);
    }
    
    /**
     * Creates an empty ResizableDialogBox with all configuration options.
     * The dialog box should not be shown until a child widget has been added using
     * {@link #setWidget(Widget)}.
     *
     ...
     * @param resizeable <code>true</code> to allow resizing by dragging the borders
     */
    public ResizableDialogBox(boolean autoHide, boolean modal, boolean showMinimizeIcon, boolean showCloseIcon, boolean resizeable) {
     ...
     */
    public final void setMinimizeIconVisible(boolean visible) {
     ...
     */
    @Override
    public HandlerRegistration addOpenHandler(OpenHandler<ResizableDialogBox> handler) {
