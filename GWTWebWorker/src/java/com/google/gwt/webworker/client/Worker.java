...

{
    ...
    public static Worker createNamedWorker( String name )

    {

	String url = "../" + name + "/" + name + ".nocache.js";

	return Worker.create( url );
    ...
    */
    ...
    public final native void postMessage(JavaScriptObject message, JsArray<MessagePort> ports) /*-{
    this.postMessage(message, ports);
    }-*/;
