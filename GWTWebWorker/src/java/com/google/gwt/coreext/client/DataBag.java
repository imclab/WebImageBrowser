...
public class DataBag extends JavaScriptObject {
   ...
   * Static Accessors
   */
  public static native boolean getBooleanProperty(JavaScriptObject obj,
      String prop) /*-{
    return !!obj[prop];
  }-*/;

  public static native double getDoubleProperty(JavaScriptObject obj,
      String prop) /*-{
    return obj[prop];
  }-*/;

  public static native int getIntProperty(JavaScriptObject obj,
      String prop) /*-{
    return obj[prop];
  }-*/;

  public static native <T extends JavaScriptObject> T getJSObjectProperty(
      JavaScriptObject obj, String prop) /*-{
    return obj[prop];
  }-*/;

  public static native String getStringProperty(JavaScriptObject obj,
      String prop) /*-{
    return obj[prop];
  }-*/;

  public static native boolean hasOwnProperty(JavaScriptObject obj,
      String prop) /*-{
